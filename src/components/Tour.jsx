...
const TourSteps = [
  {
    selector: '.first-step',
    content: 'We Welcome to the Oxfam Giftaid logger, this application helps us track gift aid sales in the store. Before we begin, let’s explore how to use the application.',
  },
  {
